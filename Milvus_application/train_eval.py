    ...
    for epoch in range(config.num_epochs):
        ...
        for i, (trains, labels) in tqdm(enumerate(train_iter)):
            ...
            if total_batch % 20 == 0:
                ...
                msg = 'Train Loss: {0:>5.2},  Train Acc: {1:>5.2}, Train F1: {2:>5.2}, Val Loss: {3:>5.2},  ' \
                      'Val Acc: {4:>5.2}, Val F1: {5:>5.2}, Time: {6}, {7}'
                print(msg.format(loss.item(), train_acc, train_f1, dev_loss, dev_acc, dev_f1, time_dif, improve))
...
def evaluate(config, model, data_iter, test=False):
    ...
    return acc, f1, loss_total / len(data_iter)